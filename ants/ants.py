...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not bees and place.is_hive != True:
            if lower_bound <= transition <= upper_bound:
                bees = place.bees
    ...
    def action(self, gamestate):
        ...
        while here != None:
            ...
            if here.ant != None:
                ant.double()
                ant.is_doubled = True
                if ant.is_container == True and ant.ant_contained != None:
                    ant.ant_contained.double()
                    ant.ant_contained.is_doubled = True
            here = here.exit
        # END Problem 12
